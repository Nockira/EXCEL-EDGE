    ...
    <div className="container mx-auto py-16 px-4">
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-lg text-gray-600">
          We provide comprehensive financial and digital solutions tailored for
          Rwandan businesses, helping you navigate tax compliance, establish
          online presence, and access valuable resources.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md border border-yellow-200">
          ...
          <p className="text-gray-600 mb-4">
            We combine local expertise with modern solutions to deliver services
            that actually work in the Rwandan context.
          </p>
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-start">
              <svg
